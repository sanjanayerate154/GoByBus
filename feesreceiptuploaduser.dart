...
class _FeesReceiptUploadState extends State<FeesReceiptUpload> {
  String? _uploadedImageName; // Variable to hold the uploaded image name
  double _uploadProgress = 0.0; // Variable to hold the upload progress

  @override
  void initState() {
    super.initState();
    // Load uploaded image name when the widget initializes
